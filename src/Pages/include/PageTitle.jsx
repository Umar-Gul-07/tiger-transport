      ...
      <div className="col-xl-4 col-md-6 mb-30">
        <div className="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
          ...
          <div className="ca-service-content ca-service-content-iner">
            ...
            <p className="pb-24">
              We provide a comprehensive suite logistics services designed to
              streamline your supply <br /> chain &amp; meet your unique
              business needs.
            </p>
      ...
      <div className="col-xl-4 col-md-6 mb-30">
        <div className="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
          ...
          <div className="ca-service-content ca-service-content-iner">
            ...
            <p className="pb-24">
              Additionally, our supply chain management services optimize every
              step your logistics process, and our e-commerce fulfillment
            </p>
            <a href="service-single.html" className="read-more">
              Read More{" "}
              <span>
      ...
      <div className="col-xl-4 col-md-6 mb-30">
        <div className="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
          ...
          <div className="ca-service-content ca-service-content-iner">
            ...
            <p className="pb-24">
              Whether it's handling project cargo with specialized requirements
              or maintaining <br />
      ...
      <div className="col-xl-4 col-md-6 mb-30">
        <div className="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
          ...
          <div className="ca-service-content ca-service-content-iner">
            ...
            <p className="pb-24">
              Finally, our Reliable Last-Mile Delivery and Freight Consolidation
